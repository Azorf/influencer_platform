...
export default function LoginPage() {
  ...
  const handleGoogleLogin = () => {
    ...
    const googleAuthUrl = `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/accounts/google/login/`;
      ...
      <div className="flex-1 flex items-center justify-center px-6">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-6 text-center text-sm text-gray-500">
            ...
            <button onClick={handleGoogleLogin} className="text-gray-900 font-medium hover:underline">
              Sign up with Google
            </button>
          </p>
        </div>
